...
cd /d "%~dp0"
if not defined VIDURA_PORT set VIDURA_PORT=8790
...
.venv\Scripts\uvicorn app.main:app --host 0.0.0.0 --port %VIDURA_PORT% --timeout-keep-alive 15 --limit-concurrency 128
