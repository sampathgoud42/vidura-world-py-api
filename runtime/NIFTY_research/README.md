# NIFTY_research — Nifty 50 5m 0.30%/4h Super-Signals (PERCENT)

Deep signal hunt on the **Nifty 50** index via its volume-bearing ETF
proxy **NIFTYBEES.NS** (the raw NSE index has no yfinance volume; the ETF
...
never past 15:30 IST.
    ...
    python nifty_intraday_bot.py --once / --backfill-today / (live loop, poll 60s)
...
(47 trades, 0 stops, **100% TP-before-SL**,
**0.82/day** over 57 sessions). `results/ensemble.csv` holds a
