"""spx_research configuration — the 0.25%/4h deep hunt on SPX.
Symmetric PERCENT target/stop +/-0.25% within 4 hours (48 x 5m bars).
...
DIV_LOOKBACK = 30
POC_BIN = 5.0              # $ bin for the volume-profile histogram
