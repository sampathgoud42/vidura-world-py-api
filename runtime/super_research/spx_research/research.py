...
Pipeline: load 60d of 5m SPX -> engineer features -> enumerate 2- and 3-block
...
def main() -> None:
    ...
    log("loading 5m SPX bars (yfinance, 60d, incl. pre-market)…")
    bars = data.load_bars()
    ...
    L = [f"# SPX 5m Super-Signal research — {stamp}\n",
         f"_{n_days} sessions of 5-minute SPX (yfinance, incl. pre-market) · entries {list(C.WINDOWS)} (CST) · "
