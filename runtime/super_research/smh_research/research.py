...
Pipeline: load 60d of 5m SMH -> engineer features -> enumerate 2- and 3-block
...
def main() -> None:
    ...
    log("loading 5m SMH bars (yfinance, 60d, incl. pre-market)…")
    bars = data.load_bars()
    ...
    L = [f"# SMH 5m Super-Signal research — {stamp}\n",
         f"_{n_days} sessions of 5-minute SMH (yfinance, incl. pre-market) · entries {list(C.WINDOWS)} (CST) · "
