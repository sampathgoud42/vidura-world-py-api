#!/usr/bin/env python
"""
smh_intraday_bot.py — live SMH Super-Signal watcher (multi-engine).

Watches completed 5-minute SMH candles during the research entry window
...
smh_intraday_signals.csv (CST timestamps, `engine` column) — same TP/SL
...
Usage:
    python smh_intraday_bot.py                 # live loop, poll 60s
    python smh_intraday_bot.py --poll 120
    python smh_intraday_bot.py --once          # one scan of the latest bar
    python smh_intraday_bot.py --backfill-today  # emit everything today fired
"""
...
A_BOOK = [
    {"book": "A", "direction": "LONG", "combo": ["above_vwap", "above_pivot", "macd_x_up_neg"],
     "window": "full_0845_1400", "nk": 0.8, "vm": 0.8,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 10},
    ...
    {"book": "A", "direction": "LONG", "combo": ["macd_x_up_neg", "hist_turn_up"],
     "window": "full_0845_1400", "nk": 0.0, "vm": 0.8,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 7},
    {"book": "A", "direction": "LONG", "combo": ["orb_break_up_v", "mom_ignite_up"],
     "window": "full_0845_1400", "nk": 0.0, "vm": 0.8,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 5},
    {"book": "A", "direction": "LONG", "combo": ["macd_x_up_neg", "strong_close"],
     "window": "pm_1130_1400", "nk": 0.8, "vm": 1.2,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 6},
]

if __name__ == "__main__":
    engine_common.run_worker(HERE, "smh", C, data, features, signals, A_BOOK)
