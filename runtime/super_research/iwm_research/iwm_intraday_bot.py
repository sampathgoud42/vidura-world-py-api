#!/usr/bin/env python
"""
iwm_intraday_bot.py — live IWM Super-Signal watcher (multi-engine).

Watches completed 5-minute IWM candles during the research entry window
...
iwm_intraday_signals.csv (CST timestamps, `engine` column) — same TP/SL
...
Usage:
    python iwm_intraday_bot.py                 # live loop, poll 60s
    python iwm_intraday_bot.py --poll 120
    python iwm_intraday_bot.py --once          # one scan of the latest bar
    python iwm_intraday_bot.py --backfill-today  # emit everything today fired
"""
...
A_BOOK = [
    ...
    {"book": "A", "direction": "SHORT", "combo": ["vwap_loss", "below_pivot", "hist_turn_dn"],
     "window": "am_0845_1130", "nk": 0.0, "vm": 1.2,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 7},
    {"book": "A", "direction": "LONG", "combo": ["above_pivot", "above_vwap_v", "rsi_thrust_up"],
     "window": "mid_1030_1300", "nk": 0.8, "vm": 0.8,
     "acc_strict": 71.4, "acc_tpsl": 100.0, "bt_trades": 7},
    {"book": "A", "direction": "LONG", "combo": ["adi_up", "above_pivot", "hist_turn_up", "vwap_lo_bounce"],
     "window": "full_0845_1400", "nk": 0.0, "vm": 0.8,
    ...
    {"book": "A", "direction": "LONG", "combo": ["above_pivot", "macd_x_up_neg", "strong_close"],
     "window": "am_0845_1130", "nk": 0.0, "vm": 0.8,
     "acc_strict": 85.7, "acc_tpsl": 100.0, "bt_trades": 7},
    {"book": "A", "direction": "LONG", "combo": ["vwap_reclaim", "vwap_lo_bounce"],
     "window": "full_0845_1400", "nk": 0.0, "vm": 0.8,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 5},
    {"book": "A", "direction": "SHORT", "combo": ["vwap_loss", "below_pivot", "weak_close", "cvd_dn"],
     "window": "am_0845_1130", "nk": 0.0, "vm": 1.2,
     "acc_strict": 100.0, "acc_tpsl": 100.0, "bt_trades": 7},
    {"book": "A", "direction": "LONG", "combo": ["delta_surge", "above_pivot", "rsi_thrust_up"],
     "window": "mid_1030_1300", "nk": 0.8, "vm": 0.8,
     "acc_strict": 83.3, "acc_tpsl": 100.0, "bt_trades": 6},
]

if __name__ == "__main__":
    engine_common.run_worker(HERE, "iwm", C, data, features, signals, A_BOOK)
