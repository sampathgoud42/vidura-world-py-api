...
Pipeline: load 60d of 5m COIN -> engineer features -> enumerate 2- and 3-block
...
def main() -> None:
    ...
    log("loading 5m COIN bars (yfinance, 60d, incl. pre-market)…")
    bars = data.load_bars()
    ...
    L = [f"# COIN 5m Super-Signal research — {stamp}\n",
         f"_{n_days} sessions of 5-minute COIN (yfinance, incl. pre-market) · entries {list(C.WINDOWS)} (CST) · "
