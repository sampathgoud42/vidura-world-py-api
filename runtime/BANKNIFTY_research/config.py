"""BANKNIFTY_research configuration — the 0.25%/4h hunt on the volume-bearing
Nifty Bank ETF proxy BANKBEES.NS (tracks the Nifty Bank index 1:1 in percent terms; the
...
TICKER = "BANKBEES.NS"          # Nifty Bank ETF (volume-bearing proxy)
TZ = "Asia/Kolkata"
...
DIV_LOOKBACK = 30
POC_BIN = 0.2              # ETF price bin for the volume-profile histogram
